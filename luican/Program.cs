...
namespace InfazLucıan
{
    public class Program
    {
        ...
        private static Spell.Targeted Q = new Spell.Targeted(SpellSlot.Q, 675) { CastDelay = 250 };
        private static Spell.Skillshot Q1 = new Spell.Skillshot(SpellSlot.Q, 1200, SkillShotType.Linear, 500, int.MaxValue, 50);
        private static Spell.Skillshot W = new Spell.Skillshot(SpellSlot.W, 1200, SkillShotType.Linear, 300, 1600, 80) { AllowedCollisionCount = int.MaxValue };
        private static Spell.Active E = new Spell.Active(SpellSlot.E, 475);
        private static Spell.Skillshot R = new Spell.Skillshot(SpellSlot.R, 1400, SkillShotType.Linear, 200, 2500, 110);
        ...
        private static void OnMenuLoad()
        {
            ...
            Laneclear.Add("LT", new KeyBind("Use Spell LaneClear (Toggle)", false, KeyBind.BindTypes.PressToggle, "J".ToCharArray()[0]));
            ...
            Laneclear.Add("LMinMana", new Slider("Min Mana (%)", 80));
            ...
            Auto.Add("AutoQ", new KeyBind("Auto Extended Q (Toggle)", false, KeyBind.BindTypes.PressToggle, "G".ToCharArray()[0]));
            ...
            Drawings.Add("DQ", new CheckBox("Draw Q", false));
        ...
        {
            if (Getcheckboxvalue(Drawings, "DEQ")) Drawing.DrawCircle(Player.Position, Q1.Range, Q.IsReady() ? Color.LimeGreen : Color.IndianRed);
            if (Getcheckboxvalue(Drawings, "DQ")) Drawing.DrawCircle(Player.Position, Q.Range, Q.IsReady() ? Color.LimeGreen : Color.IndianRed);
            if (Getcheckboxvalue(Drawings, "DW")) Drawing.DrawCircle(Player.Position, W.Range, W.IsReady() ? Color.LimeGreen : Color.IndianRed);
            if (Getcheckboxvalue(Drawings, "DE")) Drawing.DrawCircle(Player.Position, E.Range, E.IsReady() ? Color.LimeGreen : Color.IndianRed);
        }
